...
blog :
<span><i class="fa fa-github"></i> <a href="https://rehan-malak.github.io/SystemPerformanceAndSafety/">System Performance&Safety</a></span>

## Employment

`2024-today`
__CryptoNext__, Paris : __Cryptography Software Engineer__

`2022-2024`
__Intrinsic ID__, Eindhoven : __Cryptography Software Engineer__

<a href="https://www.intrinsic-id.com/products/zign">Zign</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; __C__ development and integration of the SRAM-PUF <a href="https://www.intrinsic-id.com/products/zign">Zign</a> library in MCUBoot / MbedTLS
...
<a href="https://www.miliboo.com/ekko.html">Ekko</a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; __C C++ Java__ _U-boot, Linux kernel, Android app_
...
`2012-2016`
__CEA__, Saclay PhD High-Performance Computing

&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; __C C++ Python__ _DynQCD, data analysis_
...
`2006`
__ENSIIE__, Evry BSc Software Engineering
...
__Formal methods and Proof assistant__

* Frama-C
* Why3
* Dedukti3

__Embedded/IoT OS internals__

* Contiki-NG
* Zephyr
* FreeRTOS

__Binaries and compilation__

* GCC
* GNU binutils
* LLVM

__Cryptography and Trusted Execution Environment__
...
`Linux`
[Realtime linux scheduling latency](./presentations/rtlinux.pdf) (after S.Rostedt and B.De Oliveira)

[CFS/RT mixed policies problematic use cases](./presentations/rtlinux2.pdf) (after P. Sangappa, D. Giani and S. Turlapati, S. Bhat)

[CPU topology exposed to Linux and Qemu topology/NUMA interesting examples](./presentations/numa.pdf)

`Formal methods`
[SMT solvers, CDCL and Tableaux-method and the Alt-Ergo core solvers](./presentations/smt.pdf) (after the work of the Alt-Ergo team)

[Runtime verification of Contiki-NG IoT OS with Frama-C + E-ACSL](./presentations/EACSL.pdf)

[Dedukti3 new features : proof mode with LSP server](./presentations/lambdapi.pdf)

<!-- [Runtime verification of Contiki-NG IoT OS with Frama-C + E-ACSL](./presentations/eacsl_EACSL.pdf) -->

[The F* programming language and application to Wireguard](./presentations/Rehan.pdf) (after B.Beurdouche,
J-K. Zinzindohoue)

`Lattice QCD`

[Leading-order HVP contribution to the anomalous magnetic moment of the muon in LQCD](./presentations/Soutenance.pdf) (__PhD slides__)
